...
> Reference document for the marketing-launch skill. Updated March 2026.
...
- [ ] Email sequences set up: welcome email, onboarding series (bridge to marketing-email)
...
- [ ] Launch retargeting campaigns for launch-day site visitors who did not convert (bridge to marketing-paid-ads).
...
- [ ] Assess referral / word of mouth: how many signups came from a shared referral link or "heard from a friend"? Consider activating a referral program (bridge to marketing-referral).
...
- [ ] Onboarding email sequence for new signups (bridge to marketing-email -- 5-7 email series)
